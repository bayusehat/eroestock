<div class="space-y-6">
    ...
    <x-page-header :title="$workOrder->client_work_order_id"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        <div class="rounded-lg border bg-card shadow-sm">
            <div class="border-b p-4"><h3 class="font-semibold">Order Info</h3></div>
            <div class="grid gap-4 p-4 sm:grid-cols-2">
                <div>
                    <p class="text-sm text-muted-foreground">Customer</p>
                    <p class="font-medium">{{ $workOrder->client_work_order_id ?? '-' }}</p>
                </div>
                <div>
