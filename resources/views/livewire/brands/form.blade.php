<div class="space-y-6">
    <x-page-header :title="$isEditing ? 'Edit Brand' : 'Tambah Brand'" />
    <form wire:submit="save">
        <div class="rounded-lg border bg-card shadow-sm">
            <div class="border-b p-4"><h3 class="font-semibold">Informasi Brand</h3></div>
        ...
        <div class="mt-4 flex gap-2">
            <a wire:navigate href="{{ route('brands.index') }}" class="rounded-md border px-4 py-2 text-sm hover:bg-accent">Batal</a>
