<div class="space-y-6">
    <x-page-header :title="$isEditing ? 'Edit Karyawan' : 'Tambah Karyawan'" />
    <form wire:submit="save">
        <div class="grid gap-6 lg:grid-cols-2">
            <div class="rounded-lg border bg-card shadow-sm">
                <div class="border-b p-4"><h3 class="font-semibold">Informasi Pribadi</h3></div>
                <div class="grid gap-4 p-4 sm:grid-cols-2">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <x-select wire:model="status"
                                  :options="['active' => 'Aktif', 'inactive' => 'Nonaktif', 'terminated' => 'Diberhentikan']" />
                    </div>
                    <div class="space-y-1.5">
            ...
            <div class="rounded-lg border bg-card shadow-sm">
                ...
                <div class="grid gap-4 p-4">
                    <div class="space-y-1.5"><label class="text-sm font-medium">Nama Bank</label><input wire:model="bank_name" type="text" class="h-9 w-full rounded-md border border-input bg-transparent px-3 text-sm focus:outline-none focus:ring-1 focus:ring-ring" /></div>
                    <div class="space-y-1.5"><label class="text-sm font-medium">Nomor Rekening</label><input wire:model="bank_account" type="text" class="h-9 w-full rounded-md border border-input bg-transparent px-3 text-sm focus:outline-none focus:ring-1 focus:ring-ring" /></div>
                    <div class="space-y-1.5"><label class="text-sm font-medium">Atas Nama</label><input wire:model="bank_holder" type="text" class="h-9 w-full rounded-md border border-input bg-transparent px-3 text-sm focus:outline-none focus:ring-1 focus:ring-ring" /></div>
                    <div class="space-y-1.5"><label class="text-sm font-medium">NPWP</label><input wire:model="tax_id" type="text" class="h-9 w-full rounded-md border border-input bg-transparent px-3 text-sm focus:outline-none focus:ring-1 focus:ring-ring" /></div>
                </div>
            </div>
        </div>
        <div class="mt-4 flex gap-2">
            <a wire:navigate href="{{ route('employees.index') }}" class="rounded-md border px-4 py-2 text-sm hover:bg-accent">Batal</a>
