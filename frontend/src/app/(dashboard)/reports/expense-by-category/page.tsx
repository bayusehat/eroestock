...
export default function ExpenseByCategoryPage() {
  ...
  const doughnutData = {
    labels: sortedRows.map((r) => r.category),
    datasets: [
      {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle>{t.reports.expenseByCategory.byCategory}</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead>{t.reports.expenseByCategory.byCategory}</TableHead>
                ...
                {sortedRows.length === 0 && (
                  <TableRow>
                    <TableCell colSpan={3} className="text-center text-muted-foreground">
                      {t.reports.expenseByCategory.noData}
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
